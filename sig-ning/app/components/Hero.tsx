    ...
    <div className=" container pt-8">
        <div className=" grid xl:grid-rows-2 gap-8">
            <div className="relative xl:col-span-2 xl:row-start-1 xl:row-end-[-1]">
                <img className="md:w-2/4 xs:w-3/5 w-1/4 shadow-lg hover:shadow-2xl" src="https://images.axios.com/gww320DTHEzDbCjNwaLuMT6aUrY=/2023/03/19/1679258388192.jpg"  alt="image" />
